...
pageContentObjects = [
    {name: 'bhs', html: `
        <div class="bhs academyHeader no-select">BHS</div> <br>
    ...
    `},
    {name: 'stem', html: `
        <div class="stem academyHeader no-select">STEM</div> <br>
    ...
    `},
    {name: 'vpa', html: `
        <div class="vpa academyHeader no-select">VPA</div> <br>
    ...
    `},
    {name: 'lgc', html: `
        <div class="lgc academyHeader no-select">LGC</div> <br>
